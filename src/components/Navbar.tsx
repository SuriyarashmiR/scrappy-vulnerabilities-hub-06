...
import { Moon, Sun, Home, Search, Wifi, Shield } from 'lucide-react';
...
const Navbar = () => {
  ...
  return (
    <div className="flex flex-col h-full">
      ...
      {/* Sidebar for Desktop */}
      <div className="hidden md:flex flex-col h-screen fixed left-0 top-0 bg-white dark:bg-gray-800 w-[180px] p-4 border-r border-gray-200 dark:border-gray-700 shadow-sm">
        <div className="flex items-center mb-8">
          <Shield className="text-scraper-blue mr-2" size={22} />
          <h1 className="font-bold text-lg font-heading">WEB SCRAPER</h1>
        </div>
        <div className="flex flex-col space-y-2">
          <Link to="/" className="flex items-center space-x-3 p-2 rounded-md hover:bg-gray-100 dark:hover:bg-gray-700 text-gray-700 dark:text-gray-200 hover:text-scraper-blue dark:hover:text-scraper-blue transition-colors">
            <Home size={18} />
            <span className="font-medium">HOME</span>
          </Link>
          <Link to="/search" className="flex items-center space-x-3 p-2 rounded-md hover:bg-gray-100 dark:hover:bg-gray-700 text-gray-700 dark:text-gray-200 hover:text-scraper-blue dark:hover:text-scraper-blue transition-colors">
            <Search size={18} />
            <span className="font-medium">SEARCH</span>
          </Link>
          <Link to="/connect" className="flex items-center space-x-3 p-2 rounded-md hover:bg-gray-100 dark:hover:bg-gray-700 text-gray-700 dark:text-gray-200 hover:text-scraper-blue dark:hover:text-scraper-blue transition-colors">
            <Wifi size={18} />
